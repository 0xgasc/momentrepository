...
// Official brand icon silhouettes
...
const SocialLink = memo(({ icon: Icon, svgIcon: SvgIcon, label, href }) => (
  <a
    href={href}
    target="_blank"
  ...
  >
    {SvgIcon ? (
      <SvgIcon size={20} className="text-gray-400 group-hover:text-blue-400 transition-colors" />
    ) : (
  ...
  <footer className="mt-16 border-t border-gray-700/50 pt-8 pb-6">
    <div className="max-w-7xl mx-auto px-4">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-4 mb-6">
        ...
        <SocialLink svgIcon={DiscordIcon} label="Discord" href="https://discord.gg/9MzfYFeW2p" />
        <SocialLink svgIcon={RedditIcon} label="Reddit" href="https://www.reddit.com/r/UMOband/" />
        <SocialLink svgIcon={InstagramIcon} label="Instagram" href="https://www.instagram.com/unknownmortalorchestra/" />
