          ...
          <div className="flex gap-2 flex-shrink-0">
            {moments.length > 0 && (
              <button
                ...
                className="hidden sm:flex items-center justify-center gap-1.5 px-3 py-2 text-xs sm:text-sm bg-blue-600 text-white rounded hover:bg-blue-700 transition-colors flex-1 sm:flex-none"
              >
                <Play size={14} />
                <span>Play All</span>
              </button>
