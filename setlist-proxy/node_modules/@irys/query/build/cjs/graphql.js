...
class GraphQLQuery {
    ...
    buildQuery() {
        ...
        if (this.config.numResults && ((_c = this.queryInfo.paging) === null || _c === void 0 ? void 0 : _c.limiterName) && !vars[(_d = this.queryInfo.paging) === null || _d === void 0 ? void 0 : _d.limiterName]) {
            vars[(_e = this.queryInfo.paging) === null || _e === void 0 ? void 0 : _e.limiterName] = Math.max(this.config.numResults, 1);
        }
        ...
        for (const [k, v] of Object.entries((_f = this.queryInfo.remapVars) !== null && _f !== void 0 ? _f : {})) {
        ...
        if (!((_g = this === null || this === void 0 ? void 0 : this.queryInfo) === null || _g === void 0 ? void 0 : _g.name))
     ...
     */
    pageGenerator() {
        return __asyncGenerator(this, arguments, function* pageGenerator_1() {
            do {
                const res = yield __await(this.getPage());
                if (!res)
                    return yield __await(void 0);
